...
角色系统提示词历史上存储在 `configs.example/system-prompts/` 目录（已移除）。  
...
- [后端 README](../../handbook/backend/overview.md) - 游戏引擎架构、角色系统、LLM 集成、API 文档
- [前端 README](../../handbook/frontend/overview.md) - UI 组件、状态管理、WebSocket 处理、开发指南
