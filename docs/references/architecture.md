...
- [x] 将后端白皮书条款逐条映射到 `docs/codebase/backend/src/*` 文件级文档。
- [x] 在树形文档中补充“模块间时序图”（开局、夜晚、白天、结算）。
- [x] 增加“遗留模块清理清单”（frontend 遗留组件、旧 mock 逻辑）。

## 3. 验收标准

- [x] 架构入口文档能指向白皮书与完整树形细节文档。
- [x] 核心模块变更后，入口链接与子文档均同步更新。
- [x] 新成员可仅凭 docs/codebase 理解系统边界与调用链。
