# backend/src/memory/active_context_window.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/memory/active_context_window.ts`
- 文件类型：`ts`
- 当前行数：`34`
...
### 对外暴露类型/接口/函数
- `3:export interface ContextLine {`
- `8:export class ActiveContextWindow {`
