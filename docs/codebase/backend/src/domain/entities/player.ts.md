# backend/src/domain/entities/player.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/domain/entities/player.ts`
- 文件类型：`ts`
- 当前行数：`21`
- 文件定位：V3 域模型与基础抽象文件。
...
### 对外暴露类型/接口/函数
- `3:export interface IdentityComponent {`
- `10:export function createIdentityComponent(`
