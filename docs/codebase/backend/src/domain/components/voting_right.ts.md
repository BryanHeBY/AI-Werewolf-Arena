# backend/src/domain/components/voting_right.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/domain/components/voting_right.ts`
- 文件类型：`ts`
- 当前行数：`22`
...
### 对外暴露类型/接口/函数
- `3:export interface VotingRightComponent extends PromptRenderable {`
- `8:export function createVotingRightComponent(`
