# backend/src/domain/components/badge.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/domain/components/badge.ts`
- 文件类型：`ts`
- 当前行数：`25`
- 文件定位：源码镜像文档节点。
...
### 对外暴露类型/接口/函数
- `3:export interface BadgeComponent extends PromptRenderable {`
- `8:export function createBadgeComponent(`
