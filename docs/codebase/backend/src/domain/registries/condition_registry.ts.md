# backend/src/domain/registries/condition_registry.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/domain/registries/condition_registry.ts`
- 文件类型：`ts`
- 当前行数：`15`
- 文件定位：V3 域模型与基础抽象文件。
...
### 对外暴露类型/接口/函数
- `5:export class ConditionRegistry {`

### 关键依赖（import）
- `../model`
- `../systems/win_condition_system`
- `../world`
