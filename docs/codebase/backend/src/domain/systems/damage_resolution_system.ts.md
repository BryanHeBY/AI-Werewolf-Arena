# backend/src/domain/systems/damage_resolution_system.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/domain/systems/damage_resolution_system.ts`
- 文件类型：`ts`
- 当前行数：`62`
- 文件定位：V3 ECS 系统文件，处理阶段性规则计算。
...
### 对外暴露类型/接口/函数
- `7:export interface DamageResolutionResult {`
- `12:export class DamageResolutionSystem {`

### 关键依赖（import）
- `../components/alive`
- `../components/names`
- `../components/status_marks`
- `../model`
- `../world`
