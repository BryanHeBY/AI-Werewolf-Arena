# backend/src/engine/phase_pipeline/voting_pipeline.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/engine/phase_pipeline/voting_pipeline.ts`
- 文件类型：`ts`
- 当前行数：`208`
...
### 对外暴露类型/接口/函数
- `20:export interface VotingPipelineResult {`
- `26:export class VotingPipeline {`
