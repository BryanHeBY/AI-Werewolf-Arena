...
- 源码路径：`backend/src/engine/phase_manager.ts`
- 文件类型：`ts`
- 当前行数：`283`
- 文件定位：V3 串行状态机与阶段流水线实现文件。
...
- `./event_registry`
- `./phase_pipeline/day_pipeline`
- `./phase_pipeline/night_pipeline`
- `./phase_pipeline/voting_pipeline`
