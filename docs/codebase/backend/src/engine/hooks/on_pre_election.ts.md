# backend/src/engine/hooks/on_pre_election.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/engine/hooks/on_pre_election.ts`
- 文件类型：`ts`
- 当前行数：`3`
...
### 对外暴露类型/接口/函数
- `3:export const onPreElectionHook = ActionWindow.OnPreElection;`
