# backend/src/engine/hooks/on_per_speech_gap.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/engine/hooks/on_per_speech_gap.ts`
- 文件类型：`ts`
- 当前行数：`3`
...
### 对外暴露类型/接口/函数
- `3:export const onPerSpeechGapHook = ActionWindow.OnPerSpeechGap;`
