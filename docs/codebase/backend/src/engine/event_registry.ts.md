# backend/src/engine/event_registry.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/engine/event_registry.ts`
- 文件类型：`ts`
- 当前行数：`163`
...
### 对外暴露类型/接口/函数
- `9:export interface VotedOutResult {`
- `15:export interface DeathHookResult {`
- `20:export class EventRegistry {`
