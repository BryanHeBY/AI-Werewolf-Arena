# backend/src/core/PhaseStackEngine.ts

## 1. 当前代码详细文档

- 源码路径：`backend/src/core/PhaseStackEngine.ts`
- 当前行数：`68`
- 文件职责：PhaseStack 封装，提供 push/pop/快照/深度保护。
- 对外暴露符号（来自当前代码扫描）：
- `3:export interface StackNode {`
- `8:export class PhaseStack {`
- 内容简介：
