...
- `24:export function bootstrapGame(config: BoardConfig): BootstrapResult {`

### 关键依赖（import）
- `../domain/components/alive`
- `../domain/components/badge`
- `../domain/components/camp`
- `../domain/components/names`
- `../domain/components/role`
- `../domain/components/status_marks`
- `../domain/components/voting_right`
- `../domain/entities/player`
- `../domain/model`
- `../domain/registries/condition_registry`
- `../domain/registries/role_registry`
- `../domain/systems/damage_resolution_system`
- `../domain/systems/win_condition_system`
- `../domain/world`
- `../engine/phase_manager`
- `../gateway/tool_gateway`

## 2. 未来目标 TODO

- [x] 按 V3 规范补齐职责边界与输入输出契约。
- [x] 补齐函数级输入/输出/副作用说明。
