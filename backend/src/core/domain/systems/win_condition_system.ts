...
import { WinConditionEvaluator } from "../registries/condition_registry";
...
export class WinConditionSystem {
  private readonly registry: WinConditionEvaluator;

  constructor(registry: WinConditionEvaluator) {
